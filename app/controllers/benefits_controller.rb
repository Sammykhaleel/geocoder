class BenefitsController < ApplicationController
  ...
  def index
    ...
    @benefits = Benefit.near(params[:search], 50) 
    
    else
     @benefits = Benefit.all
    end
      @hash = Gmaps4rails.build_markers(@benefits) do |benefit, marker|
      marker.lat benefit.latitude
      marker.lng benefit.longitude
      marker.infowindow benefit.site
    end  
  end
  ...
  private
    ...
    def benefit_params
      params.require(:benefit).permit(:address, :latitude, :longitude, :site)
    end
end
