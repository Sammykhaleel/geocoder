class EducationsController < ApplicationController
  ...
  private
    ...
    def education_params
      params.require(:education).permit(:address, :latitude, :longitude, :site)
    end
end
