...
class BenefitsControllerTest < ActionController::TestCase
  ...
  test "should create benefit" do
    assert_difference('Benefit.count') do
      post :create, benefit: { address: @benefit.address, latitude: @benefit.latitude, longitude: @benefit.longitude, site: @benefit.site }
    end
  ...
  test "should update benefit" do
    patch :update, id: @benefit, benefit: { address: @benefit.address, latitude: @benefit.latitude, longitude: @benefit.longitude, site: @benefit.site }
    assert_redirected_to benefit_path(assigns(:benefit))
  end
