...
class SportsControllerTest < ActionController::TestCase
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post :create, sport: { address: @sport.address, latitude: @sport.latitude, longitude: @sport.longitude, site: @sport.site }
    end
  ...
  test "should update sport" do
    patch :update, id: @sport, sport: { address: @sport.address, latitude: @sport.latitude, longitude: @sport.longitude, site: @sport.site }
    assert_redirected_to sport_path(assigns(:sport))
  end
