...
class HousingsControllerTest < ActionController::TestCase
  ...
  test "should create housing" do
    assert_difference('Housing.count') do
      post :create, housing: { address: @housing.address, latitude: @housing.latitude, longitude: @housing.longitude, site: @housing.site }
    end
  ...
  test "should update housing" do
    patch :update, id: @housing, housing: { address: @housing.address, latitude: @housing.latitude, longitude: @housing.longitude, site: @housing.site }
    assert_redirected_to housing_path(assigns(:housing))
  end
