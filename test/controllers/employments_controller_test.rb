...
class EmploymentsControllerTest < ActionController::TestCase
  ...
  test "should create employment" do
    assert_difference('Employment.count') do
      post :create, employment: { address: @employment.address, latitude: @employment.latitude, longitude: @employment.longitude, site: @employment.site }
    end
  ...
  test "should update employment" do
    patch :update, id: @employment, employment: { address: @employment.address, latitude: @employment.latitude, longitude: @employment.longitude, site: @employment.site }
    assert_redirected_to employment_path(assigns(:employment))
  end
